...
export class AlertsStore extends ComponentStore<AlertsState> {
    ...
    // readonly showAlertDangerEffect = this.effect((content$: Observable<AlertsContent>) => {
    //     return content$.pipe(mergeMap(({ header, message$ }) => {
    //         return message$.pipe(map((message) => {
    //             this.showAlertDanger(message, header)
    //         }))
    //     }));
    // })
    // readonly showAlertDarkEffect = this.effect((content$: Observable<AlertsContent>) => {
    //     return content$.pipe(mergeMap(({ header, message$ }) => {
    //         return message$.pipe(map((message) => {
    //             this.showAlertDark(message, header)
    //         }))
    //     }));
    // })
    // readonly showAlertPrimaryEffect = this.effect((content$: Observable<AlertsContent>) => {
    //     return content$.pipe(mergeMap(({ header, message$ }) => {
    //         return message$.pipe(map((message) => {
    //             this.showAlertPrimary(message, header)
    //         }))
    //     }));
    // })
    // readonly showAlertSecondaryEffect = this.effect((content$: Observable<AlertsContent>) => {
    //     return content$.pipe(mergeMap(({ header, message$ }) => {
    //         return message$.pipe(map((message) => {
    //             this.showAlertSecondary(message, header)
    //         }))
    //     }));
    // })
    // readonly showAlertSuccessEffect = this.effect((content$: Observable<AlertsContent>) => {
    //     return content$.pipe(mergeMap(({ header, message$ }) => {
    //         return message$.pipe(map((message) => {
    ...
    //     }));
    // })
    // readonly showAlertWarningEffect = this.effect((content$: Observable<AlertsContent>) => {
    //     return content$.pipe(mergeMap(({ header, message$ }) => {
    //         return message$.pipe(map((message) => {
    //             this.showAlertWarning(message, header)
    //         }))
    //     }));
    // })
    // readonly showAlertInfoEffect = this.effect((content$: Observable<AlertsContent>) => {
    //     return content$.pipe(mergeMap(({ header, message$ }) => {
    //         return message$.pipe(map((message) => {
    ...
    //     }));
    // })
    // readonly showAlertLightEffect = this.effect((content$: Observable<AlertsContent>) => {
    //     return content$.pipe(mergeMap(({ header, message$ }) => {
    //         return message$.pipe(map((message) => {
    //             this.showAlertLight(message, header)
    //         }))
    //     }));
    // })
}